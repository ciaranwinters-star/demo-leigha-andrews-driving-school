export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-6">Leigha Andrews Driving School is run by Peter, a patient and professional instructor based in Wicklow who's helped dozens of learners pass their test on the first attempt. With a calm approach and clear teaching style, Peter makes you feel prepared and confident behind the wheel.</p>
