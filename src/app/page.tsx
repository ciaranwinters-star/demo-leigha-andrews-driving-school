    ...
    <>
      <section style={{ backgroundImage: "url(/images/photo_1.jpg)", backgroundSize: "cover", backgroundPosition: "center" }} className="text-white py-28 px-4 relative">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-10 opacity-90">Expert instruction that builds real confidence on the road.</p>
      ...
      <section className="py-16 px-4" style={{ background: "#F9F9F9" }}>
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 border-t-4 hover:shadow-lg transition" style={{ borderColor: "#FFC300" }}>
          <h3 className="font-bold text-lg mb-2" style={{ color: "#003566" }}>Manual Car Lessons</h3>
          <p className="text-gray-600 text-sm leading-relaxed">Comprehensive instruction for learner drivers preparing for the practical test.</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6 border-t-4 hover:shadow-lg transition" style={{ borderColor: "#FFC300" }}>
          <h3 className="font-bold text-lg mb-2" style={{ color: "#003566" }}>HGV & Trailer Training</h3>
          <p className="text-gray-600 text-sm leading-relaxed">Specialist coaching for heavier vehicle categories and trailer reversing skills.</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6 border-t-4 hover:shadow-lg transition" style={{ borderColor: "#FFC300" }}>
          <h3 className="font-bold text-lg mb-2" style={{ color: "#003566" }}>Test Preparation</h3>
          <p className="text-gray-600 text-sm leading-relaxed">Focused lessons designed to build confidence and readiness for your driving test.</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6 border-t-4 hover:shadow-lg transition" style={{ borderColor: "#FFC300" }}>
          <h3 className="font-bold text-lg mb-2" style={{ color: "#003566" }}>Refresher Lessons</h3>
          <p className="text-gray-600 text-sm leading-relaxed">Get back on the road safely with tailored instruction for returning drivers.</p>
        </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6">
          ...
          <p className="text-gray-700 italic mb-4">"Never driven before my first lesson. Passed first time. Peter made everything so easy."</p>
          <p className="font-semibold text-sm" style={{ color: "#FFC300" }}>Caoimhe, Wicklow</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6">
          <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
          <p className="text-gray-700 italic mb-4">"Professional, patient, and brilliant at explaining things. Felt fully prepared for my test."</p>
          <p className="font-semibold text-sm" style={{ color: "#FFC300" }}>Stephen, Wicklow</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6">
          <div className="text-yellow-400 text-xl mb-3">★★★★★</div>
          <p className="text-gray-700 italic mb-4">"Peter went the extra mile. Calm, clear instructions throughout. Highly recommend."</p>
